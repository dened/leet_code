...
/// place values from highest to lowest. Converting a decimal
/// place value into a Roman numeral has the following rules:
///
/// If the value does not start with 4 or 9, select the symbol of
/// the maximal value that can be subtracted from the input, append
/// that symbol to the result, subtract its value, and convert the
...
/// Only powers of 10 (I, X, C, M) can be appended consecutively
...
class Solution {
  String intToRoman(int num) {
    const data = <(String symbol, int value)>[
      ('M', 1000),
      ('CM', 900),
      ('D', 500),
      ('CD', 400),
